...
@section('content')
    <div class="card">
        ...
        <a href="{{  route('mapel_kelas', $data->id_siswa)  }}" class="btn btn-danger mb-4">Kembali</a>
            ...
            <form action=" {{ route('halaman_update_nilai', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="{{ $data->siswa->nisn }}" readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col">
                            <input type="number" class="form-control" name="tahun_ajaran1" id="tahun_ajaran1" placeholder="2023" min="2000" max="2099" value="{{ $data->tahun_ajaran1 }}">
                        </div>
                        <div class="col-auto d-flex align-items-center">
                            <span>/</span>
                        </div>
                        <div class="col">
                            <input type="number" class="form-control" name="tahun_ajaran2" id="tahun_ajaran2" placeholder="2024" min="2000" max="2099" value="{{ $data->tahun_ajaran2 }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nh" id="nh" oninput="hitungNilai()" pattern="^[0-9.]+$" placeholder="90.9" value="{{ $data->nh }}">
                </div>

                <div class="mb-3">
                    <label for="uts" class="form-label">Nilai UTS</label>
                    <input type="text" class="form-control" name="uts" id="uts" oninput="hitungNilai()" pattern="^[0-9.]+$" value="{{ $data->uts }}">
                </div>

                <div class="mb-3">
                    <label for="uas" class="form-label">Nilai uas</label>
                    <input type="text" class="form-control" name="uas" id="semester"  oninput="hitungNilai()" pattern="^[0-9.]+$" value="{{ $data->uas }}">
                </div>
